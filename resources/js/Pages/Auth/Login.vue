...
<template>
    <GuestLayout>
        ...
        <div class=" bg-gray-900 flex justify-center w-full p-4 rounded-xl">
        <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="flex items-center">
                ...
                <span class="ms-2 text-sm text-gray-600 dark:text-gray-500">Remember me</span>
            </div>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between mt-4">
                <Link
                    ...
                    class="underline text-sm text-gray-600 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
                >
                    Forgot your password?
                </Link>

                <PrimaryButton class="mt-4 sm:mt-0 sm:ms-4 sm:w-auto" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                    Log in
                </PrimaryButton>
            </div>
            ...
            <div>
                <small class="text-gray-200">Don't have an account?
