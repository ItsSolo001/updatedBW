...
<!-- SEARCH---------------------------------------------------------------------------------------------------------BAR -->
  ...
  <!-- searchbar -->
      <div class="flex items-center max-w-sm mx-auto bg-gray-300 rounded-full shadow-md overflow-hidden" style="margin-top: 15px;">
...
<div class="bg-gradient-to-r from-gray-800 via-[#3a3a3a] to-gray-900 mt-6">
  <div class="max-w-screen-xl px-4 py-5 mx-auto sm:px-6 lg:px-1">
    <div class="grid grid-cols-1 gap-1 lg:grid-cols-3">
      <div>
        <div class="nav-logo max-w-xs flex items-center" style="user-select: none;">
          <a href="/" class="flex items-center">
            <img class="glow w-12 h-50" src="images/logo/WeblogoW.png" alt="Logo">
            <span class="logo-text-footer ml-2">BROOKLYN WAREHOUSE INC.</span>
          </a>
        </div>
      ...
      <div class="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-400">      
            <a href="#" class="hover:opacity-75" @click="showMessage('About')"> About us </a>
