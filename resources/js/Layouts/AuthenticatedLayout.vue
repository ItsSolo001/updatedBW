      ...
      <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="max-w-1xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between h-16">
            <div class="flex items-center space-x-4">
              ...
              <div class="glow flex items-center space-x-2">
                <Logo />
              </div>
              <div>
                <span class="logo-text text-ml-2" style="user-select: none;">BROOKLYN WAREHOUSE INC.</span>
              </div>


              <!-- Navigation Links -->
              <div class="hidden sm:flex items-center space-x-8">
                <span class="text-gray-400" style="user-select: none;">‖</span>
        ...
        >
          ...
          <div class="pt-2 pb-3 space-y-1" v-if="hasRole('admin')">
            <ResponsiveNavLink :href="route('users.index')" :active="route().current('users.index')">Admin</ResponsiveNavLink>
          </div>

          <div class="pt-2 pb-3 space-y-1" v-if="hasRoles(['admin', 'moderator', 'writer'])">
...
<style scoped>
.glow {
      filter: drop-shadow(0 0 4px #c9c9c9) 
